...
TRANSLATIONS = {
    'en': {
        ...
        'low_desc_gpu': "Low quality (480p) - GPU",
        'medium_desc_gpu': "Medium quality (720p) - GPU",
        'high_desc_gpu': "High quality (1080p) - GPU",
        '2k_desc_gpu': "2K quality (1440p) - GPU",
        '4k_desc_gpu': "4K quality (2160p) - GPU",
    ...
    'zh': {
        ...
        '2k_desc': "2K质量 (1440p)",
        '4k_desc': "4K质量 (2160p)",
        'low_desc_gpu': "低质量 (480p) - GPU",
        'medium_desc_gpu': "中质量 (720p) - GPU",
        'high_desc_gpu': "高质量 (1080p) - GPU",
        '2k_desc_gpu': "2K质量 (1440p) - GPU",
        '4k_desc_gpu': "4K质量 (2160p) - GPU",
    ...
    'zh_tw': {
        ...
        '2k_desc': "2K品質 (1440p)",
        '4k_desc': "4K品質 (2160p)",
        'low_desc_gpu': "低品質 (480p) - GPU",
        'medium_desc_gpu': "中品質 (720p) - GPU",
        'high_desc_gpu': "高品質 (1080p) - GPU",
        '2k_desc_gpu': "2K品質 (1440p) - GPU",
        '4k_desc_gpu': "4K品質 (2160p) - GPU",
    ...
    'ko': {
        ...
        '2k_desc': "2K 품질 (1440p)",
        '4k_desc': "4K 품질 (2160p)",
        'low_desc_gpu': "저품질 (480p) - GPU",
        'medium_desc_gpu': "중품질 (720p) - GPU",
        'high_desc_gpu': "고품질 (1080p) - GPU",
        '2k_desc_gpu': "2K 품질 (1440p) - GPU",
        '4k_desc_gpu': "4K 품질 (2160p) - GPU",
    ...
    'de': {
        ...
        'low_desc_gpu': "Niedrige Qualität (480p) - GPU",
        'medium_desc_gpu': "Mittlere Qualität (720p) - GPU",
        'high_desc_gpu': "Hohe Qualität (1080p) - GPU",
        '2k_desc_gpu': "2K-Qualität (1440p) - GPU",
        '4k_desc_gpu': "4K-Qualität (2160p) - GPU",
    ...
    'fr': {
        ...
        'low_desc_gpu': "Basse qualité (480p) - GPU",
        'medium_desc_gpu': "Qualité moyenne (720p) - GPU",
        'high_desc_gpu': "Haute qualité (1080p) - GPU",
        '2k_desc_gpu': "Qualité 2K (1440p) - GPU",
        '4k_desc_gpu': "Qualité 4K (2160p) - GPU",
    ...
    'es': {
        ...
        'low_desc_gpu': "Baja calidad (480p) - GPU",
        'medium_desc_gpu': "Calidad media (720p) - GPU",
        'high_desc_gpu': "Alta calidad (1080p) - GPU",
        '2k_desc_gpu': "Calidad 2K (1440p) - GPU",
        '4k_desc_gpu': "Calidad 4K (2160p) - GPU",
    ...
    'ru': {
        ...
        'low_desc_gpu': "Низкое качество (480p) - GPU",
        'medium_desc_gpu': "Среднее качество (720p) - GPU",
        'high_desc_gpu': "Высокое качество (1080p) - GPU",
        '2k_desc_gpu': "Качество 2K (1440p) - GPU",
        '4k_desc_gpu': "Качество 4K (2160p) - GPU",
